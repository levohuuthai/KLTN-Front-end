...
function FormUpdateProduct(props) {
  ...
  useEffect(() => {
    ...
    setColor({ ...color, value: props.dataProductDetail?.color_image.color });
    ...
    setImageDetail({
      img: props.dataProductDetail?.color_image.image,
    });
    setQuantity({ ...quantity, value: props.dataProductDetail?.countInStock });
